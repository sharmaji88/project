...
class Packer
{
	...
	public Packer(String FolderName, String FileName)
	{
		try
		{
			...
			File outfile = new File(FileName);//newfile ka output rakhne k lie......new file create krne k lie
			outstream = new FileOutputStream(FileName);//for writing pourpose in new file
